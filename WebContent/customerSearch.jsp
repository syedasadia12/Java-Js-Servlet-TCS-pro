...
<%
	...
	<div class="main-content">
		...
		<div class="update-form" style="text-align: center;">
			...
			<h1 style="text-align: center;">Customer Search</h1>
			<form name="form" id="form" method="POST" action="searchCustomer">
				<label for="cssn">CustomerSSN:</label><br> <input type="number"
					maxlength="9" id="cssn" name="cssn"><br> <br>or<br>
				<br> <label for="cid">CustomerID:</label><br> <input
					type="number" id="cid" name="cid"><br>
