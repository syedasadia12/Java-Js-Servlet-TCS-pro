...
<%@ include file="msgContainer.jsp" %>
	<div class="update-form">
			...
			<h6>Account ID: <input type="text" class="form-control" pattern="[0-9]{9}" title="Please enter a 9 digits account id number"  placeholder="Account ID" name="accountId" required="required"> </h6>
			<h6>Withdraw Amount: <input type="text" class="form-control" pattern="[0-9]{*}" title="amount should be only in number" placeholder="Withdraw Amount" name="withdrawAmount" required="required"></h6>
